...
export const ADAPTIVE_PRESET_POLICY_VERSION = "ffimg-adaptive-v2";
...
const FPS_CANDIDATES = Object.freeze([6, 8, 10, 12, 15, 18, 20, 24, 30]);
...
export function resolveAdaptivePreset({
  ...
  const withinBudget = candidates.find(
    (candidate) =>
