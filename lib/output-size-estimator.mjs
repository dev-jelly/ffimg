export const OUTPUT_SIZE_MODEL_VERSION = "ffimg-size-v1";
...
function settingsAreNormalized(settings) {
  ...
  if (!isFiniteInRange(settings.duration, 0.1, 30)) return false;
  if (!isIntegerInRange(settings.fps, 1, 30)) return false;
  if (!isIntegerInRange(settings.width, 160, 1280)) return false;
